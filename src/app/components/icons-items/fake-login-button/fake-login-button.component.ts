...
@Component({
    selector: 'app-fake-login-button',
    templateUrl: './fake-login-button.component.html',
    styleUrls: ['./fake-login-button.component.scss']
})
export class FakeLoginButtonComponent implements OnInit {
